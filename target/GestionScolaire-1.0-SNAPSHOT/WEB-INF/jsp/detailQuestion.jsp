                                            ...
                                            <div class="row">
                                                ...
                                                <button type="submit" class="btn btn-secondary" style="background-color:#5a6169; font-family: titilliumWeb-regular;">
                                                    <div class="form-label-group">
                                                        <a class="ti-back-left" style="background-color: #5a6169; color: #fff;"href=faqResponse.htm>Retour</a> 
                                                    </div></button>
                                                    ...
                                                    <div class="form-row">
                                                        <c:if test="${questions.statut == 0}">
                                                            ...
                                                            <div class=" form-group col-md-6">   
                                                                ...
                                                                <button type="submit" class="btn btn-secondary" style="background-color:#5a6169; font-family: titilliumWeb-regular;">
                                                                    <div class="form-label-group">
                                                                        <a class="ti-reload" style="background-color: #5a6169; color: #fff;"href=faqResponse.htm>  Annuler</a> 
                                                                    </div></button>
                                                        ...
                                                        <c:if test="${questions.statut == 1}">
                                                          ...
                                                          <p style="font-size: 1.2em;">${questions.description}</p>
                                                            ...
                                                            <div class=" form-group col-md-6">   
                                                                ...
                                                                <button type="submit" class="btn btn-secondary" style="background-color:#5a6169; font-family: titilliumWeb-regular;">
                                                                    <div class="form-label-group">
                                                                        <a class="ti-back-left" style="background-color: #5a6169; color: #fff;"href=faqResponse.htm>  Deja Repondue</a> 
                                                                    </div></button>
