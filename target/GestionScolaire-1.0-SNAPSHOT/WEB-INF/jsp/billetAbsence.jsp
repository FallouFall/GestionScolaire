                    ...
                    <c:if test="${findEtudiant!= null}">
                        ...
                        <div class="card mb-3 ">
                            <div class="card-header" style="text-align: center;background-color: #fff;color: #1f72b8;">
                                ...
                                <span style="font-family: dax-bold;    font-size: 1.5rem;">
                                    <div class="ibox-body">
                                        <div class="flexbox" style="text-align: center;">
                                            <div class="flexbox-b">
                                                ...
                                                <span style="font-family: dax-bold;color: #1f72b8 ;">${findEtudiant.prenom} ${findEtudiant.nom} </span>   
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="row" id="myrow">
                                         ...
                                         <div class="col-6 text-muted">Absences :</div>
                                         <div class="col-6" style="   color: #1f72b8;">${absences}</div>
                                        <div class="col-6 text-muted">Retards :</div>
                                        <div class="col-6" style="    color: #1f72b8;">${retards}</div>
                                        ...
                                        <div class="col-6">${fil}</div>
                                          <div class="col-6 text-muted">Justification :</div>
                                        <div class="col-6">${justification}</div>
                                         <div class="col-6 text-muted">Motif :</div>
                                        <div class="col-6">${motif}</div>
                                         <div class="col-6 text-muted">Delivre le :</div>
                                        <div class="col-6">${delivre} par  ${user}</div>
                                                      ...
                                                      <div class="col-6">  <button id="print" onclick="printContent('myrow');" class="btn btn-primary">
                                                <i class="ti-printer">

                                                </i> Imprimer</button></div>
                                </div>
                                        </form>
                            </div>
                        </div>
...
var val1 = $('select').val();
document.getElementById("donnee").value=val1;
});
            </script>
