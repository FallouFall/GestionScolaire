                    ...
                    <section id="team" class="pb-5 " style="margin-top: -30px;">
                        ...
                        <div class="row" style="margin-bottom: -100px; margin-top: 3px;">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <a href="documentsMathProf.htm"  style="   text-decoration: none; color: #5a6169;">
                                <div class="frontside">
                                    <div class="card ">
                                        <div class="card-body text-center">
                                            <p>     <span class="ti-ruler "   style="font-size: 3em;"></span></p>
                                            <h4 class="card-title">Mathematiques</h4>
                                    ...
                                    <div class="card ">
                                        <div class="card-body text-center">
                                            <p>     <span class="ti-calendar"   style="font-size: 3em;"></span></p>
                                                <h4 class="card-title">Histoires</h4>
                                ...
                                <div class="frontside">
                                    <div class="card ">
                                        <div class="card-body text-center">
                                            ...
                                            <h4 class="card-title">Geographie</h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                ...
                                <div class="frontside">
                                    <div class="card " >
                                        <div class="card-body text-center">
                                            <p>    <span class="ti-bag"style="font-size: 3em;"  ></span></p>
                            ...
                            <!-- Team member -->
                                ...
                                <div class="frontside">
                                    <div class="card ">
                                        <div class="card-body text-center">
                                            <p>   <span class="ti-thought" style="font-size: 3em;" ></span></p>
