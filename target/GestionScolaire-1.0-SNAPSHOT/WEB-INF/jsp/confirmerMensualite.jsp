                        ...
                        <div class="example col-md-12 ml-auto mr-auto">
                            <div class="row " >
                                ...
                                <div class="card card-signin mx-auto mt-5">
                                    <div class="card-header" style="text-align: center; color: #1f72b8; ">

                                        <span style="font-family: titilliumWeb-italic;    font-size: 1.1rem;  float: left;">
                                            GSP
                                        </span> 

                                        <span style="font-family: dax-bold;    font-size: 1.4rem; ">
                                            Payement du mois ${moisPayer} 


                                        </span> 

                                        <span class="ti-book" style="   font-size: 1.4rem; float: right;">

                                        </span> 
                                    </div>

                                    <div class="card-body">
                                        <div  style="text-align: center; color: #1f72b8;">
                                            <span style="font-family: dax-bold;    font-size: 1.2rem; ">
                                                N°: ${matricule} 
                                        ...
                                        <div class="form-group">
                                            <div class="row" id="recu">



                                                <div class="col-6 ">Etudiant :</div>
                                                <div class="col-6">${findEtudiant.matricule}</div>
                                                <div class="col-6 ">Nom :</div>
                                                <div class="col-6">${findEtudiant.nom}</div>

                                                <div class="col-6 ">Prenom :</div>
                                                <div class="col-6">${findEtudiant.prenom}</div>


                                                <div class="col-6">Classe :</div>
                                                <div class="col-6">${cls} ${fil}</div>

                                                <div class="col-6 ">Date :</div>
                                                <div class="col-6"> <%= date%></div>

                                                <div class="col-6 ">Payer :</div>
                                                <div class="col-6">${payer} Fcfa</div>


                                                <div class="col-6 ">Reste :</div>
                                                <div class="col-6">${reste} Fcfa</div>

                                                <div class="col-6 ">Mois :</div>
                                                <div class="col-6">${moisPayer} </div>

                                                <div class="col-6 ">Compable :</div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class=" form-group col-md-6">   
                                                        <button type="reset" type="button" data-dismiss="modal" class="btn btn-secondary">
                                                            <i class="ti-angle-double-left">

                                                            </i> 
                                                            <a href="comptable.htm" style="color: #fff;"> Retour</a>
                                                        </button>
                                                    </div>
