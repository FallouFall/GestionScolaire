                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        <div class="input-group with-addon-icon-left">
                                                            ...
                                                            <input type="text" class="form-control " id="nom" name="nom" placeholder="Nom" required="true" minlength="2" maxlength="30">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <div class="input-group with-addon-icon-left">
                                                            <input type="text" class="form-control" id="description" name="description" placeholder="Description" required="true" minlength="2" maxlength="30">
                                                            <span class="input-group-addon">
                                                                <i class="ti-info"></i>
                                                            </span>
                                                        </div>
                                                       ...
                                                       <div class=" form-group col-md-6">
                                                        <div class="input-group with-addon-icon-left">
                                                            <input type="text" class=" classe form-control"  name="classe"  id="classe" placeholder="Domaine" required="true" >
                                                            <span class="input-group-addon">
                                                 ...
                                                 <div class="form-group col-md-6 ">
                                                        <div class="input-group with-addon-icon-left">
                                                            ...
                                                            <input type="text" class="form-control " hidden="" id="nomFor" name="nomFor"  >
                                                        </div>
                                                    </div>
                                                    <div class=" form-group col-md-6">       
        ...
        <script>
            ...
            if (current.name == $input.val()) {
                 document.getElementById("id").value=current.id;
                   document.getElementById("nomFor").value=current.name;
            } else {
