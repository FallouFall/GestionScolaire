                ...
                <div class="container-fluid" style="    margin-top: -40px;">
                    ...
                    <ol class="breadcrumb" style="font-family: dax-bold;
                        ...
                        <li class="breadcrumb-item">
                            <span>Annee : ${annee}  <span class="ti-arrow-right" style="color: #5a6169;"> </span> Etudiant : ${matriculeEtu} <span class="ti-arrow-right" style="color: #5a6169;"> </span>  Domaine : ${dmn}<span class="ti-arrow-right" style="color: #5a6169;"> </span>   Formation : ${frn} <span class="ti-arrow-right" style="color: #5a6169;"> </span>  Cycle : ${cyn} <span class="ti-arrow-right" style="color: #5a6169;"> </span> Filiere : ${filiere} </span>
                        </li>
                                    ...
                                    <div class="row" style="margin-bottom: -100px; margin-top: 3px;">
                                        <c:forEach var="element" items="${classes}">
                                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                                <c:url var="link" value="infoInscription.htm">
                                                    <c:param name="annee" value="${annee}"/>
                                                    <c:param name="domaine" value="${domaine}"/>
                                                    <c:param name="formation" value="${formation}"/>
                                                    <c:param name="cycle" value="${cyn}"/>
                                                    <c:param name="filiere" value="${filiere}"/>
                                                    ...
                                                    <c:param name="inscription" value="${element.droitIns.inscription}"/>
                                                     <c:param name="mensualite" value="${element.droitIns.mensualite}"/>
                                                </c:url>
