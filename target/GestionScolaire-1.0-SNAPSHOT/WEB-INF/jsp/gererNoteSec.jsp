                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                        ...
                                                        <div class="input-group with-addon-icon-left">
                                                          ...
                                                          <input type="text" class=" classe form-control" name="annee" id="classe" placeholder="Choisir Annee Scolaire" required="true">
                                                        </div>
                                                    </div>
                                                       ...
                                                       <div class="form-group col-md-6">
                                                        <div class="input-group with-addon-icon-left">
                                                            ...
                                                            <input type="text" class=" classe form-control" name="idAcad" id="idAcad" hidden="" required="true">
                                                        </div>
                                                    </div>
...
<script src="js/bootstrap3-typeahead.js"></script>
   ...
   <script>
            ...
            if (current.name == $input.val()) {
                 document.getElementById("idAcad").value=current.id;

            } else {
            document.getElementById("classe").value="L'annee n'est pas bonne";
             document.getElementById("idAcad").value='';
            }
            } else {
