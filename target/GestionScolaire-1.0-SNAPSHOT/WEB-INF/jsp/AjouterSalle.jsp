        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav" >
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="gererSalles.htm">
                                        ...
                                        <form method="POST">
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <div class="input-group with-addon-icon-left">
                                                            <input type="text" class="form-control" id="description" name="descriptionSalle" placeholder="Description" required="true" minlength="2" maxlength="15">
                                                            <span class="input-group-addon">
                                                                <i class="ti-info"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <div class="input-group with-addon-icon-left">
                                                            <input type="text" class="form-control" id="surface" name="superficie" placeholder="Surface" required="true" minlength="2" maxlength="15">
                                                            <span class="input-group-addon">
                                                                <i class="ti-map"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class=" form-group col-md-6">
                                                        <div class="input-group with-addon-icon-left">
                                                            <input type="number" class="form-control" id="telephone" name="capacite" placeholder="Capacite"  minlength="9" maxlength="9"    >
                                                            <span class="input-group-addon">
