                                        ...
                                        <form method="POST">
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class=" form-group col-md-6">
                                                        <div class="input-group with-addon-icon-left">
                                                            <input type="password" class="form-control" name="password"  id="password" placeholder="Password" required="true"  minlength="5" maxlength="15">
                                                            <span class="input-group-addon">
                                                                <i class="ti-lock"></i>
                                                            </span>
                                                        </div>
