  ...
  <li class="nav-item" style="margin-top: 20px;">
     ...
     <ol class="breadcrumb" style="font-family: dax-bold;
                            ...
                            <li class="breadcrumb-item">
                                 <span>Annee :${annee} <span class="ti-arrow-right" style="color: #5a6169;"> </span> Etudiant :${matriculeEtu} <span class="ti-arrow-right" style="color: #5a6169;"> </span> Domaine :${dmn} <span class="ti-arrow-right" style="color: #5a6169;"> </span>  Formation :${frn}    </span>
                            </li>
                            ...
                            <div class="row "  >
                                ...
                                <section id="team" class="pb-5 " style="margin-top: -30px;">
                                    <div class="row" style="margin-bottom: -100px; margin-top: 3px;">
                                        <c:forEach var="element" items="${cyclefor}">
                                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                                       <c:url var="link" value="filiereIns.htm">
                                                             <c:param name="annee" value="${annee}"/>
                                                       <c:param name="domaine" value="${domaine}"/>
                                                       <c:param name="formation" value="${formation}"/>
                                                       <c:param name="cycle" value="${element.id}"/>
                                                        <c:param name="cyn" value="${element.nom}"/>
