                                    ...
                                    <div class="form-row">
                                        <div class=" form-group col-md-6">
                                            <div class="input-group with-addon-icon-left">
                                                <input type="text" class=" classe form-control" name="classe" data-minlength="6" id="classe" placeholder="Classe" required="true"><ul class="typeahead dropdown-menu" role="listbox" style="top: 38px; left: 0px; display: none;"><li class="active"><a class="dropdown-item" href="#" role="option">Licence 1</a></li><li><a class="dropdown-item" href="#" role="option">Licence 2</a></li><li><a class="dropdown-item" href="#" role="option">Licence 3</a></li><li><a class="dropdown-item" href="#" role="option">Licence 1</a></li><li><a class="dropdown-item" href="#" role="option">Licence 2</a></li><li><a class="dropdown-item" href="#" role="option">Licence 3</a></li></ul>
